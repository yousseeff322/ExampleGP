...
{ /* init interrput*/
	MNVIC_voidEnableInterrupt(IRQn);
	MNVIC_voidSetPendingFlag(IRQn);
}
/** Disanable NVIC Interrupt **/
void CAN_voidDeiniterputInit(u8 IRQn)
{ /* deinit interrput*/
	MNVIC_voidDisableInterrupt(IRQn);
	MNVIC_voidClearPendingFlag(IRQn);
}
...
/*************	 Callbacks functions 	************************/
void CAN_TxMailbox0CompleteCallback() { /* Handle TX Complete */ }
void CAN_TxMailbox1CompleteCallback() { /* Handle TX Complete */ }
void CAN_TxMailbox2CompleteCallback() { /* Handle TX Complete */ }
void CAN_RxFifo0MsgPendingCallback() { /* Handle RX Data */ }
void CAN_ErrorCallback() { /* Handle CAN Errors */ }
